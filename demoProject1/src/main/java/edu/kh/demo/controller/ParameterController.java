...
public class ParameterController {
	...
	public String paramMain() {
		...
		// thymeleaf의 접두사 : calsspath:/templates/
		// thymeleaf의 접미사 : .html
		...
		// @GetMapping("test1")
		// @RequestMapping(value = "test1", method = RequestMethod)
	...
	public String test4(
			...
			@RequestParam(name = "saveId", required = false) String save
			) {
